...
cluster0 = {
    ...
    'redis': [
        ...
        ('127.0.0.5:20000', '/tmp/redis-20000'), ('127.0.0.5:30001', '/tmp/redis-30000'), #(示例配置, 主从端口分别用2xxxx/3xxxx)
    ...
    'twemproxy': [
        # host:port, install path
        ('127.0.0.5:22000', '/tmp/twemproxy-22000'),
        ('127.0.0.5:22001', '/tmp/twemproxy-22001'),
        ('127.0.0.5:22002', '/tmp/twemproxy-22002'),
        #...
    ],
    'sentinel':[
